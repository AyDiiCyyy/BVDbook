...
<style>
     ...
     .thank-you-page {
        ...
        /* Icon thành công với màu sắc và size lớn */
        .fa-check-circle {
            color: #28a745;
            font-size: 80px;
            margin-bottom: 20px;
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-content">
                        <h1 class="breadcrumb-hrading">Cám ơn</h1>
        ...
        <div class="container">
            ...
            <div class="card shadow-lg">
                <div class="card-body text-center">
                    ...
                    <p class="lead">Thanh toán của bạn đã được xử lý thành công.</p>
                    ...
                    <!-- Các nút điều hướng -->
                    <div class="mt-4">
                        <a href="{{ route('index') }}" class="btn btn-primary btn-lg">Tiếp tục mua sắm</a>
