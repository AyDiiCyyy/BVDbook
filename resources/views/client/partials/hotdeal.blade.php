            ...
            <article class="list-product">
                ...
                <div class="product-wrapper" style="margin-top: 5%">
                    <div class="product-decs">
                        <a class="inner-link"
                            href="shop-4-column.html"><span>{{ $sale->ProductCategories?->first()?->category->name }}</span></a>
                        <h2><a href="single-product.html"
                                class="product-link">{{ Str::limit($sale->name, 25, '...') }}</a></h2>
                        ...
                        <div class="pricing-meta">
                            <ul>
                                <li class="old-price">{{ number_format($sale->price, 0, ',') }}₫</li>
                                <li class="current-price">{{ number_format($sale->sale, 0, ',') }}₫</li>
                                <li class="discount-price">-{{ round((($sale->price - $sale->sale) / $sale->price) * 100) }}%</li>
                            </ul>
                        </div>
                    ...
                    <div class="in-stock">Chỉ còn: <span>{{$sale->quantity}} sản phẩm</span></div>
                    <div class="clockdiv">
